...
def parse_config(data: dict) -> dict:
    """Parse USALT config file.

    Args:
        data (dict): raw YAML input from USALT analysis config file
...
def parse_sampleinfo(data: dict) -> dict:
    """Parse USALT sample info file.

    Args:
        data (dict): raw YAML input from USALT qc sample info file
...
def parse_qcmetrics(metrics: dict) -> dict:
    """Parse USALT qc metrics file.
    Args:
        metrics (dict): raw YAML input from USALT qc metrics file
