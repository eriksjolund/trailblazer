...
from trailblazer.exc import UsaltStartError
...
class UsaltCli(object):
    ...
    """Wrapper around Usalt command line interface."""

    def __init__(self, script):
        """Initialize USALT command line interface."""
        self.script = script
    ...
    def __call__(self, config, family, **kwargs):
        ...
        if process.returncode != 0:
            raise UsaltStartError('error starting analysis, check the output')
        return process
