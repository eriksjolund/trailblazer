# -*- coding: utf-8 -*-
"""Parse the BALSAMIC config file."""
...
def parse_config(data: dict) -> dict:
    """Parse BALSAMIC config file.

    Args:
        data (dict): raw YAML input from BALSAMIC analysis config file
...
def parse_sampleinfo(data: dict) -> dict:
    """Parse BALSAMIC sample info file.

    Args:
        data (dict): raw YAML input from BALSAMIC qc sample info file
...
def parse_qcmetrics(metrics: dict) -> dict:
    """Parse BALSAMIC qc metrics file.
    Args:
        metrics (dict): raw YAML input from BALSAMIC qc metrics file
